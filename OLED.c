...
#define OLED_W_D0(x)        ((x)?(DL_GPIO_setPins(GPIOB,DL_GPIO_PIN_14)) : (DL_GPIO_clearPins(GPIOB,DL_GPIO_PIN_14)) )
#define OLED_W_D1(x)        ((x)?(DL_GPIO_setPins(GPIOB,DL_GPIO_PIN_14)) : (DL_GPIO_clearPins(GPIOB,DL_GPIO_PIN_14)) )
#define OLED_W_RES(x)       ((x)?(DL_GPIO_setPins(GPIOB,DL_GPIO_PIN_14)) : (DL_GPIO_clearPins(GPIOB,DL_GPIO_PIN_14)) )
#define OLED_W_DC(x)        ((x)?(DL_GPIO_setPins(GPIOB,DL_GPIO_PIN_14)) : (DL_GPIO_clearPins(GPIOB,DL_GPIO_PIN_14)) )
#define OLED_W_CS(x)        ((x)?(DL_GPIO_setPins(GPIOB,DL_GPIO_PIN_14)) : (DL_GPIO_clearPins(GPIOB,DL_GPIO_PIN_14)) )
